...
(function() {
  ...
  jQuery(function() {
    $.tags = function(element, options) {
      ...
      this.displayPopovers = (options.popovers != null ? options.popovers : false);
      ...
      this.formatTag = function(i, tag) {
        ...
        if (_this.displayPopovers === true) {
          ...
          return "<div class='tag label btn-info' rel='popover' data-placement='bottom' data-content='" + popoverContent + "' data-original-title='" + tag + "'><span>" + tag + "</span><a> <i class='icon-remove-sign icon-white'></i></a></div>";
        } else {
          return "<div class='tag label btn-info'><span>" + tag + "</span><a> <i class='icon-remove-sign icon-white'></i></a></div>";
        }
      };
      ...
      this.init = function() {
        ...
        this.renameTag("tag a", "INFINITY");
        this.addTagWithContent("Fillibuster", "central");
