  ...
  jQuery(function() {
    $.tags = function(element, options) {
      ...
      this.adjustInputPosition = function() {
        ...
        pBottom = tagPosition != null ? tagPosition.top + tagElement.outerHeight() : 20;
      ...
      this.formatTag = function(i, tag) {
        return "<div class='tag label btn-info' rel='popover' data-placement='bottom' data-content='content' data-original-title='title'><span>" + tag + "</span><a> <i class='icon-remove-sign icon-white'></i></a></div>";
      };
